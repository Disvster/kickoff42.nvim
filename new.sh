...
printf "\n${WARN} Make sure you cloned to this repo to the ${BLUE}$HOME/.config${RESET} directory with the name ${BLUE}nvim${RESET}."
...
printf "  2.   Press the ${GREEN} \\ ${RESET} key to open the file browser and navigate to the ${BLUE}lua/plugins/42/42-header.lua${RESET} plugin file.\n"
printf "  3. ${WARN} Update your personal info:\n"
printf "       Edit the ${BOLD}user${RESET} and ${BOLD}mail${RESET} fields in it to your own ${BLUE}42${RESET} username and email!\n"
printf "  4.   Navigate to and explore the modular plugin structure in the ${BLUE}init.lua${RESET} file to learn more about all the things you can do with this config!\n"
