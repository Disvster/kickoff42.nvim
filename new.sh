...
printf "     - Edit the ${BOLD}user${RESET} and ${BOLD}mail${RESET} fields in the ${BOLD}lua/plugins/42/42-header.lua${RESET} plugin file to your own ${BLUE}42${RESET} username and email!\n"
